...
// Exported so lib/ingest/finalizeUpload.js's URL-fetch path (see
// app/api/ingest/fetch-url) identifies itself the same way, rather than a
// second, drifting copy of this string.
export const USER_AGENT = "VidhiOS-Adaptive/1.0 (personal study tool; not a bulk crawler)";
...
export function looksLikePdf(url, contentType) {
