...
export const INGEST_DOC_TYPE_CONFIGS = {
  ...
  // Raised alongside syllabus/pyq_paper above, same reasoning -- not yet
  // observed failing live for these two specifically, but there's no reason
  // to expect the same model to behave differently here, and there's no
  // real cost to having the headroom (see the comment above).
  ncert_chapter: {
    itemType: "source",
    sourceTier: "ncert",
    maxTokens: 6000,
