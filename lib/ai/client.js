...
//
// Text/JSON model: DeepSeek V3 (deepseek/deepseek-chat-v3.1:free) — a free
// OpenRouter model with solid structured-JSON reliability. Switched back
// from anthropic/claude-haiku-4.5 (paid -- OpenRouter doesn't make
// Anthropic's models free, it just avoids Anthropic's own prepaid-billing
// requirement) after the OpenRouter account ran out of credits mid-use.
// Swap MODEL below for a paid model again if quality/cost tradeoffs
// change -- see https://openrouter.ai/models?max_price=0 for other free
// options.
