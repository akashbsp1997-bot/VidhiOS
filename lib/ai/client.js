...
//
// Text/JSON model: Claude Haiku 4.5 via OpenRouter (anthropic/claude-haiku-4.5)
// — grading fires on every submitted answer and question/lesson generation
// fires occasionally, so a fast/cheap model is the right default. Note this
// is NOT a free OpenRouter model — routing through OpenRouter doesn't make
// Anthropic's models free, it just avoids Anthropic's prepaid billing
// requirement. Swap MODEL below if you want a different quality/cost
// tradeoff (OpenRouter also has $0 models at https://openrouter.ai/models?max_price=0).
