...
/**
 * One source's advancedness score. `source.ncertLevel` not yet set on an
 * NCERT source (shouldn't happen once tagging is consistent, but not fatal)
 * falls back to 'senior' -- the same default drizzle/0011's backfill used
 * for every pre-existing NCERT source in this app.
 */
