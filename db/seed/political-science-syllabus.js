...
//
// pyqFrequency below is precomputed from the 84 real, verbatim PYQs in
// db/seed/political-science-pyqs.js (2024 Paper I, 2023 Paper I, 2021 Paper
// II -- fetched from upsc.gov.in / web.archive.org snapshots of the same
// official PDFs, text-layer extraction, not OCR or third-party paraphrase),
// same convention as db/seed/gs2-syllabus.js. Earlier revisions of this
// file seeded every row at 0 because the PSIR PYQ text available at the
// time was paraphrased by a compilation site's extraction tool, not
// verbatim -- that gap is closed now that real official PDFs were sourced;
// see political-science-pyqs.js's header for the sourcing detail. One
// subtopic (psir-iw7, "India and the UN system") stays at 0 -- none of the
// 3 fetched papers happened to touch it; not a sign it's unimportant, just
// not yet covered by the PYQs on hand.
export const politicalScienceSyllabusSeed = [
  // Paper I, Section A -- Political Theory and Indian Political Thought
  { id: "psir-pt1", subjectId: "political-science-optional", paper: 1, section: "Political Theory and Indian Political Thought", topicText: "Political Theory: meaning and approaches", pyqFrequency: 5 },
  {
    id: "psir-pt2",
  ...
  { id: "psir-pt7", subjectId: "political-science-optional", paper: 1, section: "Political Theory and Indian Political Thought", topicText: "Concept of power: hegemony, ideology and legitimacy", pyqFrequency: 3 },
  {
    id: "psir-pt8",
    subjectId: "political-science-optional",
    paper: 1,
  ...
  { id: "psir-igp4", subjectId: "political-science-optional", paper: 1, section: "Indian Government and Politics", topicText: "Principal organs of the Union Government: executive, legislature, judiciary — structure, functions, reform trends", pyqFrequency: 1 },
  { id: "psir-igp5", subjectId: "political-science-optional", paper: 1, section: "Indian Government and Politics", topicText: "Principal organs of State Government: executive, legislature, judiciary — structure, functions, reform trends", pyqFrequency: 1 },
  {
    id: "psir-igp6",
    subjectId: "political-science-optional",
    paper: 1,
  ...
  { id: "psir-igp10", subjectId: "political-science-optional", paper: 1, section: "Indian Government and Politics", topicText: "Caste, Religion and Ethnicity in Indian Politics", pyqFrequency: 4 },
  {
    id: "psir-igp11",
    subjectId: "political-science-optional",
    paper: 1,
  ...
  { id: "psir-cp2", subjectId: "political-science-optional", paper: 2, section: "Comparative Politics", topicText: "State in comparative perspective: capitalist and socialist state models, post-colonial state models", pyqFrequency: 1 },
  {
    id: "psir-cp3",
    subjectId: "political-science-optional",
    paper: 2,
  ...
  { id: "psir-cp4", subjectId: "political-science-optional", paper: 2, section: "Comparative Politics", topicText: "Globalisation: concept and effect on state autonomy; responses from developed and developing societies", pyqFrequency: 1 },
  ...
  { id: "psir-ir4", subjectId: "political-science-optional", paper: 2, section: "International Relations", topicText: "United Nations: envisaged role and actual record, specialized UN agencies, need for UN reforms", pyqFrequency: 1 },
  { id: "psir-ir5", subjectId: "political-science-optional", paper: 2, section: "International Relations", topicText: "Regionalisation of world politics: EU, ASEAN, APEC, SAARC, NAFTA", pyqFrequency: 1 },
  {
    id: "psir-ir6",
    subjectId: "political-science-optional",
    paper: 2,
  ...
  { id: "psir-iw1", subjectId: "political-science-optional", paper: 2, section: "India and the World", topicText: "Indian Foreign Policy: determinants, institutions of policy-making, continuity and change", pyqFrequency: 2 },
  {
    id: "psir-iw2",
    subjectId: "political-science-optional",
    paper: 2,
  ...
  { id: "psir-iw3", subjectId: "political-science-optional", paper: 2, section: "India and the World", topicText: "India's relations with major powers: US, Russia, China", pyqFrequency: 2 },
  {
    id: "psir-iw4",
    subjectId: "political-science-optional",
    paper: 2,
  ...
  { id: "psir-iw5", subjectId: "political-science-optional", paper: 2, section: "India and the World", topicText: "India and the Global South: South-South cooperation", pyqFrequency: 1 },
  { id: "psir-iw6", subjectId: "political-science-optional", paper: 2, section: "India and the World", topicText: "India and the Global Centres of Power: US, EU, Japan, China", pyqFrequency: 2 },
  ...
  { id: "psir-iw8", subjectId: "political-science-optional", paper: 2, section: "India and the World", topicText: "India and the nuclear question: changing perceptions and policy", pyqFrequency: 1 },
  {
    id: "psir-iw9",
    subjectId: "political-science-optional",
    paper: 2,
